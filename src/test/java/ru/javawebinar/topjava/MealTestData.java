...
public class MealTestData {
    ...
    public static final int ID_NOT_FOUND = START_SEQ + 100;
    public static final int USER_ID_NOT_FOUND = START_SEQ + 200;

    public static final Meal dublicateDateMeal =  new Meal(LocalDateTime.of(2020, Month.JANUARY,30, 13, 0), "Завтрак", 100);
